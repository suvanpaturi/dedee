...
# Default settings
DEFAULT_API_URL = "http://neo4j-uploader-service:5001"
...
hostname = socket.gethostname()  # This will get the pod name in Kubernetes
DEFAULT_DEVICE_ID = os.environ.get("DEVICE_ID", hostname)
...
def get_pod_region():
    """Get the region from Kubernetes downward API (if available)."""
    region_file = "/etc/podinfo/region"
